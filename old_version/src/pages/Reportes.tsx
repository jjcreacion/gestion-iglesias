      ...
      <Tabs defaultValue="asistencia" className="space-y-4">
        ...
        <TabsContent value="asistencia" className="space-y-4">
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                <CardTitle className="font-serif">Asistencia y Ganados por Mes</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-serif">Top Ganadores del Mes</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="consolidacion" className="space-y-4">
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-serif">Distribución por Roles</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-serif">Estado de Consolidación</CardTitle>
              </CardHeader>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <Card key={escuela.titulo}>
                <CardHeader>
                  <CardTitle className="font-serif text-lg">{escuela.titulo}</CardTitle>
                </CardHeader>
