...
import { Settings, BookOpen, Shield, Bell } from "lucide-react";
        ...
        <div className="space-y-6 p-4 lg:p-6">
            ...
            <Tabs defaultValue="general" className="space-y-4">
                ...
                <TabsContent value="general" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle className="title-section">Información de la Iglesia</CardTitle>
                            <CardDescription>
                ...
                <TabsContent value="guias" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle className="title-section">Configuración de Guías</CardTitle>
                            <CardDescription>
                ...
                <TabsContent value="roles" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle className="title-section">Permisos por Rol</CardTitle>
                            <CardDescription>
                ...
                <TabsContent value="notificaciones" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle className="title-section">Preferencias de Notificación</CardTitle>
                            <CardDescription>
