        ...
        <div className="space-y-6 p-4 lg:p-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                        ...
                        <CardContent>
                            <div className="space-y-2">
                                {miembrosCelula.map((miembro) => (
                                    <div
                                        key={miembro.id}
                                        className={`flex items-center gap-4 rounded-lg border p-3 transition-colors ${asistencia[miembro.id]
                ...
                <div className="space-y-4">
                    <Card>
                        <CardHeader className="pb-3">
                            <CardTitle className="title-section">Resumen</CardTitle>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader className="pb-3">
                            <CardTitle className="title-section">Últimos Domingos</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-3">
                                {[
