...
export function AppSidebar() {
    ...
    return (
        <Sidebar collapsible="icon" className="border-r-0 top-16 h-[calc(100vh-4rem)]">
            <SidebarHeader className="border-b border-sidebar-border p-3 group-data-[collapsible=icon]:px-3">
                <div className="flex items-center gap-1">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-sidebar-primary shrink-0">
                        <Church className="h-7 w-7 text-sidebar-primary-foreground" />
                    </div>
                    {!collapsed && (
                ...
                <SidebarGroup className="mt-4">
                    <Collapsible open={activityOpen} onOpenChange={setActivityOpen}>
                        <CollapsibleTrigger className="flex w-full items-center justify-between px-3 py-2">
                            ...
                            {!collapsed && (
                                <ChevronDown
                                    className={`h-4 w-4 text-sidebar-foreground/60 transition-transform ${activityOpen ? "rotate-180" : ""
                                        }`}
                                />
                            )}
                        </CollapsibleTrigger>
